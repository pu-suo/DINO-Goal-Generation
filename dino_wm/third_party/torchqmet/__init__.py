...
# NOTE (vendoring): the upstream `pqe/` subpackage (Poisson Quasimetric Embedding +
# its cdf_ops C/CUDA extension) is intentionally NOT vendored -- this project uses only
# IQE / MRN. See UPSTREAM.md. If PQE is ever needed, re-copy `pqe/` from upstream.
from .iqe import IQE
from .mrn import MRN, MRNFixed
from .neural_norms import DeepNorm, WideNorm

__all__ = ['IQE', 'MRN', 'MRNFixed', 'DeepNorm', 'WideNorm']
__version__ = "0.1.0"
